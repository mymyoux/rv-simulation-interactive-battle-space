...
macro(writeResourceFile destDir isDebug)
	...
	file(APPEND ${FILE_DEST} "FileSystem=${CMAKE_SOURCE_DIR}/media/materials/textures/planets\n")
	file(APPEND ${FILE_DEST} "Zip=${CMAKE_SOURCE_DIR}/media/materials/textures/planets/Earth.zip\n")	
	file(APPEND ${FILE_DEST} "Zip=${CMAKE_SOURCE_DIR}/media/materials/textures/planets/Moon.zip\n")
	file(APPEND ${FILE_DEST} "FileSystem=${CMAKE_SOURCE_DIR}/media/materials/shaders\n")
	file(APPEND ${FILE_DEST} "FileSystem=${CMAKE_SOURCE_DIR}/media/materials/programs\n")
	...
	file(APPEND ${FILE_DEST} "FileSystem=${CMAKE_SOURCE_DIR}/media/cegui/imagesets\n")	
   	file(APPEND ${FILE_DEST} "[Fonts]\n")
	file(APPEND ${FILE_DEST} "FileSystem=${CMAKE_SOURCE_DIR}/media/cegui/fonts\n")	
	file(APPEND ${FILE_DEST} "[LookNFeel]\n")
	file(APPEND ${FILE_DEST} "FileSystem=${CMAKE_SOURCE_DIR}/media/cegui/looknfeel\n")	
    file(APPEND ${FILE_DEST} "[Schemes]\n")
	file(APPEND ${FILE_DEST} "FileSystem=${CMAKE_SOURCE_DIR}/media/cegui/schemes\n")	
	file(APPEND ${FILE_DEST} "[Layouts]\n")
	file(APPEND ${FILE_DEST} "FileSystem=${CMAKE_SOURCE_DIR}/media/cegui/layouts\n")		
    file(APPEND ${FILE_DEST} "[General]\n")
	file(APPEND ${FILE_DEST} "FileSystem=${CMAKE_SOURCE_DIR}/media/cegui/general\n")	
	file(APPEND ${FILE_DEST} "FileSystem=${CMAKE_SOURCE_DIR}/media/cegui/texts\n")	
